...
const HeaderTimeOff = (props) => {
    ...
    const {timeOffDetail, employeeDetail} = useSelector((state)=>({
    ...
    const settingGps1 = async() => {
        // console.log("the employee_data is ===>", employee_data.isgpstracking, "the notification===>", employee_data.isnotifications)
    ...
    // console.log("the employee details are============>", employeeDetail?.totalbillable)
        ...
        <View style={styles.Parent}>
            <View style={styles.Container}>
                <View style={{ flexDirection: 'row' }}>
                    ...
                    <View style={{ width: "45%" }}>
                        <Text style={[Textstyles.bold, styles.mainHeading]}>{picClick ? "Notifications" : "TimeOff" && !menuClick ? "TimeOff" : "Settings"}</Text>
                    </View>
                    <TouchableOpacity style={{ width: "20%" }} onPress={() => menuClicked()}>
                ...
                {menuClick &&
                    <View style={styles.notificationContainer}>
                        ...
                        <TouchableOpacity style={styles.menuItemContainer} onPress={() => handleNavigation('Dashboard')}>
                ...
                <View style={{ bottom: 10, flexDirection: 'row', marginTop: '2%' }}>
                    <View style={{ width: '60%' }}>
                        <Text style={[Textstyles.medium, styles.TimeOffText]}>Time Off Balance</Text>
                    </View>
                    <View style={{ width: '40%', alignSelf: 'flex-end' }}>
                        <Text style={[Textstyles.bold, { color: "#1b2041", fontSize: 15, textAlign: 'right', marginEnd: 11 }]}>
                            {`${employeeDetail?.totalbillable}`}
                        </Text>
                        
                            {/* <Text style={[Textstyles.bold, styles.Hours]}>244</Text> of
                            <Text style={[Textstyles.bold, styles.Hours]}> 320</Text> Hours</Text> */}
                    </View>
                </View>
            </View>
        </View>
